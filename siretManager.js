...
console.log(chalk.blue('Enter 1 to start processing files'));
console.log(chalk.blue('Enter 2 to pause all processes'));
console.log(chalk.blue('Enter 3 to resume all processes'));
console.log(chalk.blue('Enter 4 to split csv'));
console.log('\n');
